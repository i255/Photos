...
{
    public class libMouseEvent
    {
        public libMouseEventKind Kind;
        public SKPoint InitialPoint;
        public SKPoint CurrentPoint;
        public SKPoint Offset;

        internal bool Consumed { get; private set; }
        internal BaseView Consumer;

        public readonly libMouseEvent InitialEvent;

        public libMouseEvent() { }

        public libMouseEvent(libMouseEvent initial)
        {
            InitialEvent = initial;
            if (initial != null)
                InitialPoint = initial.InitialPoint;
        }

        public void Consume(BaseView consumer)
        {
            Consumed = true;
            ...
            if (consumer != null)
            {
                ...
                if (InitialEvent != null)
                    InitialEvent.Consumer = consumer;
            }
        }
    }
    public class libKeyMessage
    {
        public libKeys Key;
        internal bool Consumed { get; private set; }
